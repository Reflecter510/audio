...
model_name="model/mfcc/save_model.h5"
struct_name="model/mfcc/save_struct.h5"
weights_name="model/mfcc/save_weights.h5"

# *************** ImageDataGenerator *************** #
train_dir = r'./data_set/mfcc/train/'
validation_dir = r'./data_set/mfcc/test/'
# 训练集数据增强
...
plt.savefig("model/mfcc/0_acc.png")
plt.cla()
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig("model/mfcc/0_loss.png")
plt.cla()
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig("model/mfcc/1_acc.png")
plt.cla()
# summarize history for loss
plt.plot(history.history['loss'])
plt.plot(history.history['val_loss'])
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig("model/mfcc/1_loss.png")
plt.cla()
